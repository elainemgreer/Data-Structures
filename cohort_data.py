...
def all_students_tuple_list(filename):
    ...
    # #  for each  line we loop over, create tuple with first+last name, concat 
    # as adding, add all other pieces of info to tuple
        if line_list[4] == "I":
        ...
        student_tuple = (line_list[0] + " " + line_list[1], line_list[2],
                        line_list[3], line_list[4])
        student_list.append(student_tuple)

    #  constantly append tuple to master list 
...
hogwarts_student_list = all_students_tuple_list("cohort_data.txt")
...
def find_cohort_by_student_name(student_list):
    ...
    # #call function and save list returned into variable
    # hogwarts_student_list = all_students_tuple_list("cohort_data.txt")

    #loop over list and grab cohort data for give student name
    # if student not in student_list, print out a errormessg, else return cohort
...
print(find_cohort_by_student_name(hogwarts_student_list))
